...
public class PopupObj {
    ...
    //initialise
    public PopupObj(GameView gameView) {
    ...
    public void draw(Canvas canvas, Bitmap tilemapImage) {
        ...
        Rect flower1Rect = new Rect(0, 175,90, 265); // Entire tilemap
        ...
        //2
        Rect flower2Rect = new Rect(90, 175,175, 265);
        ...
        //3
        Rect flower3Rect = new Rect(175, 175,265, 265);
        ...
        //4
        Rect flower4Rect = new Rect(265, 175,350, 265);
        ...
        //5
        Rect flower5Rect = new Rect(355, 175,440, 265);
