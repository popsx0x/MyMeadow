...
public class SpraylObj {
    ...
    //initialise
    public SpraylObj(GameView gameView, Bitmap tilemapImage){
    ...
    public void draw(Canvas canvas){
        ...
        Rect srcRect = new Rect(980, 250, 1150, 600); // Entire tilemap

        // Define the destination rectangle based on this.x and this.y
        int desiredWidth = 100; // Adjust this value according to your preference
        int desiredHeight = 140; // Adjust this value according to your preference
